...
public class Exe_14 {
    ...
    private static void exercise1() {
        ...
        System.out.println("Sum for each: " + sumForA);
        ...
        System.out.println("Sum for each: " + sumForB);
        ...
        for (int i = 0; i < itemsA.size(); i++) {
            ...
            System.out.println("Sum For I: " + sumForC);
    ...
    private static void exercise2() {
        ...
        System.out.println("Smallest item: " + minNumber);
        System.out.println("Largest item: " + maxNumber);
    }
     ...
     * <p> Potremmo cambiare la variable timesTableValue in un multiplo di 8 o del numero di riferimento
